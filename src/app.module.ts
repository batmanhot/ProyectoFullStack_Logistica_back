...
import { AtencionesAlertaModule } from './atenciones-alerta/atenciones-alerta.module';
...
@Module({
  imports: [
    ...
    AprobacionesModule,
    // Centro de Alertas (tenant) — seguimiento de atención, 2026-09-13
    AtencionesAlertaModule,
